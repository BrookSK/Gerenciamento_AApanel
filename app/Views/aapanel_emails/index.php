    ...
    <table border="1" cellpadding="6" cellspacing="0">
        ...
        <tbody>
            <?php foreach (($emails ?? []) as $e) : ?>
                ...
                $link = ($linksByResourceName ?? [])[$email] ?? null;
                ?>
                <tr>
                    ...
                    <td>
                        <?php if (is_array($link)) : ?>
                            ...
                            <form method="post" action="/aapanel-emails/unlink" style="display:inline; margin-left:6px;">
                                <input type="hidden" name="email" value="<?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>">
                                <button type="submit">Desvincular</button>
                            </form>
                        <?php else : ?>
                            <form method="post" action="/aapanel-emails/link" style="display:inline;">
                                <input type="hidden" name="email" value="<?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>">
